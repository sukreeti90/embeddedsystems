...
a.serial device servers
b.Small size for easy installation
c.Real COM and TTY drivers for Windows, Linux, and macOS
d.Standard TCP/IP interface and versatile operation modes
e.Easy-to-use Windows utility for configuring multiple device servers
f.SNMP MIB-II for network management
g.Configure by Telnet, web browser, or Windows utility
h.Adjustable pull high/low resistor for RS-485 ports
i.Cost effective and 5 year warranty
j.Adjustable Termination and Pull High/Low Resistors

NPort® 5100 device servers are designed to make serial devices network-ready in an instant. 
The small size of the servers makes them ideal for connecting devices such as card readers and payment terminals to an IP-based Ethernet LAN. 
Use the NPort 5100 device servers to give your PC software direct access to serial devices from anywhere on the network.
...
Operation Modes                                                                      Disabled, Ethernet Modem, Pair Connection, Real COM, Reverse Telnet, TCP Client,
                                                                                     TCP Server, UDP
